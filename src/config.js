...
export const config = {
  ...
  REMINDER_WA: process.env.REMINDER_WA == "true"|| false,
  REMINDER_CLOCK_IN: process.env.REMINDER_CLOCK_IN || '09:25',
  REMINDER_CLOCK_OUT: process.env.REMINDER_CLOCK_OUT || '20:00',
